...
// Actualizar clases de la tarjeta de vista previa
...
function drawCanvasCard(callback) {
  ...
  ctx.font = fontWeight + ' 44px ' + fontName + ', sans-serif';
  ctx.textAlign = 'center';
  ctx.textBaseline = 'middle';
  
  var maxTextWidth = 900;
  var lineHeight = 64;
  var wrappedLines = wrapText(ctx, text, maxTextWidth);
  
  var totalTextHeight = wrappedLines.length * lineHeight;
  var startY = 600 - (totalTextHeight / 2) + 20;
  ...
  ctx.fillText(ref, 600, startY + totalTextHeight + 40);
  
  ctx.fillStyle = footerColor;
  ctx.font = 'bold 22px Outfit, sans-serif';
  ctx.fillText('PRINCIPIOS BÁSICOS DE LA BIBLIA', 600, 1080);
